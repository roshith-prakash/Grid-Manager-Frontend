    ...
    <>
      ...
      {loadingUser && (
        <div className="lg:min-h-screen bg-bgwhite dark:bg-darkbg dark:text-darkmodetext w-full pb-20">
          ...
          {/* Profile Info Div */}
          <div className="bg-white dark:bg-secondarydarkbg dark:border-white/25 shadow-xl -translate-y-14 border-2 min-h-52 pt-20 pb-10 rounded-2xl mx-5 md:mx-10 lg:mx-20">
            {/* Floating Image */}
            ...
            {tabValue == "teams" ? (
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 py-10 px-2 gap-x-2 gap-y-10">
                {Array(4)
                  ...
                  ?.map(() => {
                    return (
                      <div className="mx-auto bg-[#e1e1e1]/25 max-w-3xs w-full rounded-2xl flex flex-col dark:bg-white/5  px-5 py-5 transition-all hover:shadow-md hover:bg-white/10">
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-6 flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12">
              ...
              <div className="flex-1 text-center md:text-left flex flex-col justify-center min-h-[160px]">
                ...
                <div className="mt-6 flex items-center justify-center md:justify-start gap-2 text-sm font-medium text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-white/5 w-fit px-4 py-2 rounded-2xl mx-auto md:mx-0">
                  ...
                  <span>
                    Joined {dayjs(new Date(user?.data?.user?.createdAt)).format("MMM DD, YYYY")}
                  </span>
                </div>
              </div>
            </div>
                            ...
                            >
                              ...
                              <div className="relative mb-4">
                                <div className="flex items-center gap-3 mb-2">
                                  <div className="w-10 h-10 bg-cta/20 dark:bg-cta/30 rounded-2xl flex items-center justify-center">
                              ...
                              <div className="relative z-10 mb-4">
                                <div className="bg-slate-50 dark:bg-white/10 rounded-2xl p-3">
                              ...
                              <div className="space-y-4">
                                ...
                                <div className="pt-4 border-t border-slate-200 dark:border-white/15">
                                  <Link
                                    ...
                                    className="flex items-center gap-3 hover:bg-slate-50 dark:hover:bg-white/10 rounded-2xl p-2 -m-2 transition-colors"
                                  >
                                    <div>
                                      <Avatar
